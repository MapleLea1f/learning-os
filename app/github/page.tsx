...
export default function GitHubEvidencePage() {
  ...
  return <main className="github-shell">
    <header className="github-header"><div><div className="eyebrow">Phase 1 · 工程证据</div><h1>GitHub 提交展示</h1><p>选择日期和公开仓库，查看并带回当天提交。</p></div><Link className="button button-secondary" href={`/?date=${date}`}>返回日报</Link></header>
    {!token ? <section className="github-card github-empty"><h2>需要 GitHub 登录</h2><p>请先回到日报登录 GitHub。仅读取公开仓库。</p><Link className="button" href="/">返回日报登录</Link></section> : <>
